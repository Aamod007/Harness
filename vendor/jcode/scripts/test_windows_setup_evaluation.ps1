...
try {
    ...
    Invoke-Case 'release_lookup_avoids_unauthenticated_github_api' {
        Assert-Equal 'v1.2.3' (Resolve-JcodeReleaseTagFromUri 'https://github.com/aamodkumar/jcode/releases/tag/v1.2.3') 'release redirect parser should extract the stable tag'
        Assert-Equal 'v1.2.3-rc.1' (Resolve-JcodeReleaseTagFromUri 'https://github.com/aamodkumar/jcode/releases/tag/v1.2.3-rc.1?source=latest') 'release redirect parser should stop before query parameters'
        ...
        function Invoke-WebRequest {
            ...
            if ($Uri -eq 'https://github.com/aamodkumar/jcode/releases/latest') {
        ...
        try {
            ...
            Assert-Equal 'https://github.com/aamodkumar/jcode/releases/download/v1.2.3' $bases[1] 'GitHub should remain the final fallback'
        } finally {
