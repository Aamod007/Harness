...
LINUX_URL="https://github.com/aamodkumar/jcode/releases/download/${VERSION}/jcode-linux-x86_64.tar.gz"
LINUX_ARM_URL="https://github.com/aamodkumar/jcode/releases/download/${VERSION}/jcode-linux-aarch64.tar.gz"
MACOS_ARM_URL="https://github.com/aamodkumar/jcode/releases/download/${VERSION}/jcode-macos-aarch64.tar.gz"
MACOS_INTEL_URL="https://github.com/aamodkumar/jcode/releases/download/${VERSION}/jcode-macos-x86_64.tar.gz"
...
git clone --depth 1 git@github.com:aamodkumar/homebrew-jcode.git "$BREW_DIR" 2>/dev/null

cat > "$BREW_DIR/Formula/jcode.rb" <<EOF
class Jcode < Formula
  desc "AI coding agent powered by Claude and ChatGPT"
  homepage "https://github.com/aamodkumar/jcode"
  version "$VERSION_NUM"
  license "MIT"
...
# Maintainer: Aamod Kumar
pkgname=jcode-bin
pkgver=$VERSION_NUM
pkgrel=1
pkgdesc="AI coding agent powered by Claude and ChatGPT"
arch=('x86_64')
url="https://github.com/aamodkumar/jcode"
license=('MIT')
provides=('jcode')
conflicts=('jcode')
source=("$LINUX_URL")
