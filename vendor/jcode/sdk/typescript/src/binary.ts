...
const PLATFORM_PACKAGES: Record<string, string> = {
  "linux-x64": "@aamodkumar/jcode-linux-x64",
  "linux-arm64": "@aamodkumar/jcode-linux-arm64",
  "darwin-x64": "@aamodkumar/jcode-darwin-x64",
  "darwin-arm64": "@aamodkumar/jcode-darwin-arm64",
  "win32-x64": "@aamodkumar/jcode-win32-x64",
  "win32-arm64": "@aamodkumar/jcode-win32-arm64",
};
