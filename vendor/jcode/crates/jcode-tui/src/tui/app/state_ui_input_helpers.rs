...
{"type":"user","message":{"role":"user","content":"Organize my windows by project"},"cwd":"/home/Aamod","sessionId":"abc"}
...
"#,
        ...
        assert_eq!(candidate.working_dir.as_deref(), Some("/home/Aamod"));
        assert_eq!(
    ...
    fn parses_codex_input_text_blocks() {
        ...
        std::fs::write(
            &path,
            r#"{"type":"session_meta","payload":{"id":"sid","cwd":"/home/Aamod/jcode"}}
...
"#,
        ...
        assert_eq!(candidate.working_dir.as_deref(), Some("/home/Aamod/jcode"));
