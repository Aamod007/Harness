...
mod tests {
    ...
    fn present_swarm_notification_formats_file_activity_with_compact_path_and_preview() {
        let presentation = present_swarm_notification(
            "moss",
            &NotificationType::FileConflict {
                path: "/home/Aamod/jcode/src/tool/communicate.rs".to_string(),
            ...
            "⚠ File activity: /home/Aamod/jcode/src/tool/communicate.rs - moss just edited this file you previously worked with: edited lines 323-348 (1 occurrence)",
            false,
        );
